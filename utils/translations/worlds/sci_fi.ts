export const sciFiWorld = {
  ...
  races: {
    ...
    'Zoltan': { description: "Beings of pure energy, fast and brilliant. +3 Intelligence, +2 Speed.", bonuses: { intelligence: 3, speed: 2 } },
    "K'tharr": { description: "A feline warrior race, agile and perceptive. +3 Dexterity, +2 Perception.", bonuses: { dexterity: 3, perception: 2 } },
    'Rockman': { description: "Crystalline silicon-based lifeforms, incredibly durable but slow. +4 Constitution, +1 Strength.", bonuses: { constitution: 4, strength: 1 } },
    'Mantis': { description: "Insectoid hunters, revered for their lightning-fast reflexes and combat prowess. +3 Speed, +2 Dexterity.", bonuses: { speed: 3, dexterity: 2 } },
    'Engi': { description: "A symbiotic race of organic beings and nanites, the Engi are unparalleled engineers and problem-solvers. +3 Intelligence, +2 Trade.", bonuses: { intelligence: 3, trade: 2 } },
    'The Void-Touched': { description: "Beings forever changed by exposure to raw hyperspace, their minds are powerful but their bodies are frail. +3 Wisdom, +2 Intelligence.", bonuses: { wisdom: 3, intelligence: 2 } },
    'Symbiote': { description: "A composite being of two organisms in perfect harmony, one providing brute strength, the other tactical intellect. +3 Strength, +2 Intelligence.", bonuses: { strength: 3, intelligence: 2 } },
    'The Archivist': { description: "A crystalline, silicon-based lifeform dedicated to preserving all universal knowledge, possessing immense memory and processing power. +4 Intelligence, +1 Wisdom.", bonuses: { intelligence: 4, wisdom: 1 } },
    'Uplifted Cephalopod': { description: 'A cephalopod species granted sapience through advanced genetic engineering. They perceive the world through a unique lens, possessing multiple brains and incredible problem-solving skills, but their aquatic origins make them clumsy outside of low-gravity environments. +3 Intelligence, +2 Wisdom.', bonuses: { intelligence: 3, wisdom: 2 } },
    'Nanite Collective': { description: 'Not a single organism, but a sapient swarm of nanites that can form a humanoid shape. They are incredibly resilient and can reconfigure their bodies, but lack the nuance of organic emotion. +3 Constitution, +2 Intelligence.', bonuses: { constitution: 3, intelligence: 2 } },
    'High-Gravity Human': { description: 'Humans born and raised on a high-gravity world. Their bodies are dense and powerfully built, making them exceptionally strong and durable, though their reflexes can be slower in standard gravity. +3 Strength, +2 Constitution.', bonuses: { strength: 3, constitution: 2 } },
    'Phase-Walker': { description: 'Beings with a natural, unstable connection to other dimensions. They can briefly phase out of reality, making them incredibly elusive and difficult to track, but this instability makes them physically fragile. +3 Dexterity, +2 Luck.', bonuses: { dexterity: 3, luck: 2 } },
    'Dominion Symbiote': { description: 'A parasitic species that takes control of a host body. While the host provides physical form, the symbiote possesses a cunning, manipulative intellect and a thirst for power. +3 Persuasion, +2 Intelligence.', bonuses: { persuasion: 3, intelligence: 2 } },
    'Geode': { description: 'Silicon-based lifeforms with crystalline bodies. Geodes are incredibly durable and process information with cold, deliberate logic, making them thoughtful but slow to act. +3 Constitution, +2 Wisdom.', bonuses: { constitution: 3, wisdom: 2 } },
    'Thran Hivemind': { description: 'Insectoid beings linked by a collective consciousness. While individuals are simple, the hive acts as one, excelling at coordinated tasks and understanding complex systems. +3 Perception, +2 Trade.', bonuses: { perception: 3, trade: 2 } },
    'Lumin': { description: 'Beings of sentient plasma held within sophisticated containment suits. They are incredibly fast and seem to bend probability, but their physical forms are inherently unstable. +3 Speed, +2 Luck.', bonuses: { speed: 3, luck: 2 } },
    'Nautilid': { description: 'Amphibious humanoids evolved in the crushing depths of high-pressure oceans. Their bodies are dense and powerful, built to withstand extreme environments. +3 Constitution, +2 Strength.', bonuses: { constitution: 3, strength: 2 } },
    'Silvanite': { description: 'Mobile, sentient plant-based organisms. They have a deep, almost spiritual connection to the life cycles of the galaxy and possess immense patience and insight. +3 Faith, +2 Wisdom.', bonuses: { faith: 3, wisdom: 2 } },
  },
  classes: {
